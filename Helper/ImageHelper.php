...
namespace Cytracon\FileAllowed\Helper;

use Magento\Framework\App\Helper\AbstractHelper;

class ImageHelper extends AbstractHelper
{
    const XML_PATH_VECTOR_EXTENSIONS = 'cytracon_fileallowed/extensions/vector';
    const XML_PATH_WEB_IMAGE_EXTENSIONS = 'cytracon_fileallowed/extensions/web_image';
